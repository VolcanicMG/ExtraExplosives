...
namespace ExtraExplosives.NPCs.CaptainExplosiveBoss
{
    public class BossRocket : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            Vector2 position71 = new Vector2(npc.position.X + num248, npc.position.Y + num249) - npc.velocity * 3.1f;
            int width67 = npc.width - 25;
            int height67 = npc.height - 25;
            ...
            Vector2 position72 = new Vector2(npc.position.X + num248, npc.position.Y + num249) - npc.velocity * 3.1f;
