...
{
    public class LargeExplosiveItem : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Large Explosive");
            Tooltip.SetDefault("That did a lot some damage");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("LargeExplosiveProjectile"); //This defines what type of projectile this item will shoot
