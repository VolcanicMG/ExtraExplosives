...
namespace ExtraExplosives.Items.Explosives
{
    ...
    public class BulletBoomItemAcceleration : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            if (CalamityMod != null)
            { 
                DisplayName.SetDefault("BulletBoom [c/AC90FF:(Acceleration Bullet)]");
        ...
        public override void SetDefaults()
        {
            if (CalamityMod != null)
            {
                ...
                item.shoot = ModContent.ProjectileType<BulletBoomProjectileAcceleration>(); //This defines what type of projectile this item will shoot
            }
        }
    }
