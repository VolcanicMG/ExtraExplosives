...
namespace ExtraExplosives.Items.Explosives
{
    ...
    public class BulletBoomItemEnhanced : ModItem
    {
        ...
        public override void SetDefaults()
        {
            if (CalamityMod != null)
            {
                ...
                item.shoot = ModContent.ProjectileType<BulletBoomProjectileEnhanced>(); //This defines what type of projectile this item will shoot
            }
        }
    }
