...
{
    public class BreakenTheBankenItem : ExplosiveItem
    {
        public override void SafeSetDefaults()
        {
            ...
            // TODO this rarity is probably wrong, check
            Item.rare = ItemRarityID.Expert;     //The color the title of your item when hovering over it ingame
            ...
            Item.shoot = ModContent.ProjectileType<BreakenTheBankenProjectile>(); //This defines what type of projectile this item will shoot
