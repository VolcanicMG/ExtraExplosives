...
namespace ExtraExplosives.Items.Explosives
{
    public class ClusterBombItem : ExplosiveItem
    {
        public override void SafeSetDefaults()
        {
            ...
            Item.rare = ItemRarityID.LightPurple;   //The color the title of your item when hovering over it ingame
            ...
            Item.shoot = ModContent.ProjectileType<ClusterBombProjectile>(); //This defines what type of projectile this item will shoot
