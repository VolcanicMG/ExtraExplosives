...
{
    public class DeliquidifierItem : ExplosiveItem
    {
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.shoot = Mod.Find<ModProjectile>("DeliquidifierProjectile").Type; //This defines what type of projectile this item will shoot
