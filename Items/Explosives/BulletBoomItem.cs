...
namespace ExtraExplosives.Items.Explosives
{
	public class BulletBoomItem : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = proj.projectile.type; //This defines what type of projectile this item will shoot
		...
		/*public override void AddRecipes()
		{
			...
			recipe.AddRecipe();
		}*/	// Recipe disabled due to it giving all of them a recipe, 
		// Currently only craftable through Cpt. Explosive
	}
}