...
namespace ExtraExplosives.Items.Explosives
{
    public class TheLevelerItem : ExplosiveItem
    {
        public override void SafeSetDefaults()
        {
            ...
            Item.rare = ItemRarityID.Lime;   //The color the title of your item when hovering over it ingame
            ...
            Item.shoot = ModContent.ProjectileType<TheLevelerProjectile>(); //This defines what type of projectile this item will shoot
