...
{
	public class BulletBoomItemParty : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<BulletBoomProjectileParty>();//This defines what type of projectile this item will shoot
		}
	}
}