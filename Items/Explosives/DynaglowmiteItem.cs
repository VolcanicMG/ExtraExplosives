...
{
    public class DynaglowmiteItem : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Dynaglowmite");
            Tooltip.SetDefault("Spawns in a bunch of glow sticks. Great for splunking!");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("DynaglowmiteProjectile"); //This defines what type of projectile this item will shoot
