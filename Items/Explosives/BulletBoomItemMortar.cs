...
namespace ExtraExplosives.Items.Explosives
{
    ...
    public class BulletBoomItemMortar : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            if (CalamityMod != null)
            { 
                DisplayName.SetDefault("BulletBoom [c/AC90FF:(Mortar Round)]");
        ...
        public override void SetDefaults()
        {
            if (CalamityMod != null)
            {
                ...
                item.damage = 130;     //The damage stat for the Weapon.   
                item.shoot = ModContent.ProjectileType<BulletBoomProjectileMortar>(); //This defines what type of projectile this item will shoot
            }
        }
    }
