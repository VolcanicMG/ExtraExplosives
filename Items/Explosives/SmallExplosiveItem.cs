...
{
	public class SmallExplosiveItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Small Explosive");
			Tooltip.SetDefault("Eh, about the size of a bomb...");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = mod.ProjectileType("SmallExplosiveProjectile"); //This defines what type of projectile this item will shoot
