...
{
    public class SmallExplosiveItem : ExplosiveItem
    {
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.shoot = Mod.Find<ModProjectile>("SmallExplosiveProjectile").Type; //This defines what type of projectile this item will shoot
