...
{
    public class WhoInvitedYouItem : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Who Invited You?");
            Tooltip.SetDefault("Ever want an unwanted guest? \n" +
                "Comes complete with peanut gallery functionality.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<WhoInvitedYouProjectile>(); //This defines what type of projectile this item will shoot
