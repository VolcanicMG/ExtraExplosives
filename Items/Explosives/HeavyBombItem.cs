...
namespace ExtraExplosives.Items.Explosives
{
    public class HeavyBombItem : ExplosiveItem
    {
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.value = Item.buyPrice(0, 4, 17, 0);   //How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 3 silver)
            Item.noUseGraphic = true;
            Item.noMelee = true;      //Setting to True allows the weapon sprite to stop doing damage, so only the projectile does the damge
            Item.shoot = Mod.Find<ModProjectile>("HeavyBombProjectile").Type; //This defines what type of projectile this item will shoot
