...
namespace ExtraExplosives.Items
{
    public class ArenaBuilderItem : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Explodes into existents a 500 X 300 arena equiped with only the finest of platforms and lights.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.buyPrice(10, 0, 0, 0);   //How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 3 silver)
