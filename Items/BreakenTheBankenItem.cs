...
namespace ExtraExplosives.Items
{
    public class BreakenTheBankenItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.buyPrice(1, 0, 0, 0);   //How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 3 silver)
