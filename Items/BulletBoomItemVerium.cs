...
namespace ExtraExplosives.Items
{
    ...
    public class BulletBoomItemVerium : ModItem
    {
        ...
        public override void SetDefaults()
        {
            if (CalamityMod != null)
            {
                ...
                item.shoot = ModContent.ProjectileType<BulletBoomProjectileVerium>(); //This defines what type of projectile this item will shoot
            }
        }
    }
