            ...
            if (Projectile.timeLeft <= 19940)
            {
                ...
                if (Projectile.ai[1] > 0f)
                {
                    ...
                    if (Main.npc[num142].active && Main.npc[num142].CanBeChasedBy(this, true) && !Main.npc[num142].dontTakeDamage)
                    {
                        ...
                        if (Math.Abs(Projectile.position.X + (float)(Projectile.width / 2) - num143) + Math.Abs(Projectile.position.Y + (float)(Projectile.height / 2) - num144) < 2000f)
                        {
                            flag3 = true;
