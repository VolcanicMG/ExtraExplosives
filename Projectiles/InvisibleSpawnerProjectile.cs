        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                else if (projectile.knockBack == 3)
                {
                    ...
                    Projectile.NewProjectile(position.X, position.Y - 16, 0, 0, mod.ProjectileType("MegaExplosiveProjectile"), 0, 0, Main.myPlayer, 0.0f, 0);
                ...
                else if (projectile.knockBack == 4)
                {
                    ...
                    for (y = position.Y - 70; y < position.Y + 71; y++)
                    {
                        for (x = position.X - 70; x < position.X + 71; x++)
                        {
                            ...
                            if (yCntr == 7) //Or 7
                            {
                                Projectile.NewProjectile(x, y, speedX, speedY, mod.ProjectileType("SmallExplosiveProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                ...
                else if (projectile.knockBack == 7)
                {
                    ...
                    for (y = position.Y - 70; y < position.Y + 71; y++)
                    {
                        for (x = position.X - 70; x < position.X + 71; x++)
                        {
                            ...
                            if (yCntr == 7) //Or 7
                            {
                                Projectile.NewProjectile(x, y, speedX, speedY, mod.ProjectileType("BulletBoomProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                            }
                            x = x + 20;
                            xCntr++;
                        }
                ...
                else if (projectile.knockBack == 10)
                {
                    ...
                    for (int x = -radius; x <= radius; x++)
                    {
                        for (int y = -radius; y <= radius; y++)
                        {
                            ...
                            {
                                Projectile.NewProjectile(position.X, position.Y, 0, Main.rand.Next(20) - 10, mod.ProjectileType("DynaglowmiteProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                    ...
                    Projectile.NewProjectile(position.X, position.Y, 0, 0, mod.ProjectileType("BigBouncyDynamiteProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                ...
                else if (projectile.knockBack == 13)
                {
                    ...
                    Projectile.NewProjectile(position.X, position.Y - 16, 0, 0, mod.ProjectileType("HydromiteProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                    for (int i = 0; i < 70; i++)
                    {
                        Vector2 position1 = new Vector2(position.X - 400 / 2, position.Y - 163 / 2);
                ...
                else if (projectile.knockBack == 19)
                {
                    ...
                    Main.PlaySound(SoundID.Item14, (int)position.X, (int)position.Y);
                    Projectile.NewProjectile(position.X - 16, position.Y - 32, 0, -7, mod.ProjectileType("ClusterBombProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                    Projectile.NewProjectile(position.X + 16, position.Y - 32, 0, -7, mod.ProjectileType("ClusterBombProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
                ...
                else if (projectile.knockBack == 22)
                {
                    ...
                    Projectile.NewProjectile(position.X, position.Y, 0, -5, mod.ProjectileType("GiganticExplosiveProjectile"), 0, 5, Main.myPlayer, 0.0f, 0);
