    ...
    public class NPCSpawnerProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            ExplosionDamageProjectile.DamageRadius = 2;
                Projectile.NewProjectile(position.X, position.Y, 0, 0, mod.ProjectileType("ExplosionDamageProjectile"), 1, 0, projectile.owner, 0.0f, 0);

                //NPC.NewNPC((int)player.Center.X, (int)player.Center.Y + 20, mod.NPCType("CaptainExplosive"), 0, 0f, 0f, 0f, 0f, 255);

                Projectile.NewProjectile(position.X, position.Y, 0, 0, mod.ProjectileType("InvisibleSpawnerProjectile"), 0, 1, projectile.owner, 0.0f, 0);
